...
import com.example.sportspot.databinding.ActivityBadmintonBinding
...
class BadmintonActivity : AppCompatActivity() {
    ...
    private var _binding: ActivityBadmintonBinding? = null
    private val binding get() = _binding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivityBadmintonBinding.inflate(layoutInflater)
